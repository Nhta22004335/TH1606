        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <div class="group bg-white rounded-xl shadow-xl p-8 transform hover:scale-[1.03] transition duration-300 cursor-pointer border-t-4 border-blue-500">
                   ...
                   <a href="/app/views/khach_hang/nhao.php" class="block text-center mt-4 text-sm font-semibold text-blue-500 group-hover:text-blue-700 transition">Xem chi tiết <i class="fas fa-arrow-right ml-1 text-xs"></i></a>
                </div>
                ...
                <div class="group bg-white rounded-xl shadow-xl p-8 transform hover:scale-[1.03] transition duration-300 cursor-pointer border-t-4 border-yellow-500">
                    ...
                    <a href="/app/views/khach_hang/datnen.php" class="block text-center mt-4 text-sm font-semibold text-yellow-500 group-hover:text-yellow-700 transition">Xem chi tiết <i class="fas fa-arrow-right ml-1 text-xs"></i></a>
                </div>
                ...
                <div class="group bg-white rounded-xl shadow-xl p-8 transform hover:scale-[1.03] transition duration-300 cursor-pointer border-t-4 border-green-500">
                    ...
                    <h4 class="text-2xl font-bold text-center mb-2 text-gray-900 group-hover:text-green-600 transition">Biệt Thự</h4>
                    <p class="text-gray-600 text-center text-sm">
                        Tìm kiếm căn hộ, văn phòng cho thuê phù hợp với nhu cầu của bạn.
                    </p>
                    <a href="/app/views/khach_hang/bietthu.php" class="block text-center mt-4 text-sm font-semibold text-green-500 group-hover:text-green-700 transition">Xem chi tiết <i class="fas fa-arrow-right ml-1 text-xs"></i></a>
                </div>
                ...
                <div class="group bg-white rounded-xl shadow-xl p-8 transform hover:scale-[1.03] transition duration-300 cursor-pointer border-t-4 border-purple-500">
                    ...
                    <a href="/app/views/khach_hang/dvmg.php" class="block text-center mt-4 text-sm font-semibold text-purple-500 group-hover:text-purple-700 transition">Xem chi tiết <i class="fas fa-arrow-right ml-1 text-xs"></i></a>
                </div>
