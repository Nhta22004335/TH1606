<?php
// app/views/khach_hang/datnen.php
...
// Patterns để match "đất", "đất nền" (không phân biệt hoa thường)
// Chúng ta sẽ tạo các placeholder named :loai0, :loai1, ... để bind an toàn
$patterns = ['%đất nền%', '%dat nen%', '%đất%', '%dat%'];
...
<head>
    <meta charset="utf-8">
    <title>Đất nền - Đất Việt BĐS</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-50 text-gray-800">
    <div class="max-w-7xl mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-4">Đất nền & Đất</h1>

        <form method="GET" class="mb-6 flex gap-2">
            <!-- Nếu site dùng trang trung tâm, giữ page param -->
            <input type="hidden" name="page" value="khach_hang/datnen">
        ...
        <?php else: ?>
            ...
            if ($pages > 1): 
                $base = 'trangchu.php?page=khach_hang/datnen';
