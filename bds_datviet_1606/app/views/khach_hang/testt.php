...
<style>
        ...
        .banner-bg::before {
            ...
            width: 100%;
            height: 100%;
            background: url('https://via.placeholder.com/1500x300') no-repeat center;
...
<header class="bg-white border-b shadow-sm">
 ...
 <!-- Banner Section -->
<section class="banner-bg py-6 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 banner-content">
        <div class="bg-white shadow-md rounded-lg p-4 mb-6">
            <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
                <div class="w-full md:w-auto">
                    <div class="flex space-x-2 mb-2">
                        <a href="muaban.php" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Mua bán</a>
                        <a href="chothue.php" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Cho thuê</a>
                        <a href="duan.php" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Dự án</a>
                    </div>
                    <form action="timkiem.php" method="GET">
                        <input type="text" name="keyword" placeholder="Tìm kiếm" class="w-full md:w-96 h-10 border border-gray-300 px-3 text-sm rounded-md focus:ring-1 focus:ring-blue-400 focus:border-blue-400 outline-none">
                        <!-- Thêm filter nếu cần -->
                        <button type="submit" class="h-10 px-4 bg-red-500 text-white rounded-md flex items-center justify-center hover:bg-red-600 mt-2 md:mt-0 md:ml-2">
                            <i class="fas fa-search"></i>
                        </button>
                    </form>
                </div>
                <div class="flex flex-wrap gap-2">
                    <!-- Giữ nguyên filter, nhưng tích hợp vào form nếu cần -->
                    <select class="h-10 border border-gray-300 px-3 text-sm rounded-md focus:ring-1 focus:ring-blue-400">
                        <option>Toàn quốc</option>
                        <!-- ... -->
                    </select>
                    <!-- Các select khác tương tự -->
                    <button class="h-10 px-4 bg-red-500 text-white rounded-md flex items-center justify-center hover:bg-red-600">
                        <i class="fas fa-search"></i>
                    </button>
                    <button class="h-10 px-4 bg-blue-500 text-white rounded-md flex items-center justify-center hover:bg-blue-600">
                        <i class="fas fa-map-marked-alt"></i> Bản đồ
                    </button>
                    <button class="h-10 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600">Đặt lại</button>
                </div>
            </div>
        </div>
    </div>
